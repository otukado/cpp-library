...
data:
  ...
  bundledCode: "#line 2 \"src/data-structure/segment-tree.hpp\"\n#include<vector>\n\
    #include <cassert>\n\nnamespace otukado {\n\n\ntemplate<typename T, T e, auto\
    \ op> //SegmentTree<int, 0, [&](int a, int b)-> int {return max(a, b)}>\nclass\
    \ SegmentTree {\nprivate:\n    int n;\n    int size;\n    std::vector<T> data;\n\
    \    \npublic:\n    class Proxy {\n    private:\n        SegmentTree& seg;\n \
    \       int index;\n\n    public:\n        Proxy(SegmentTree& seg, int index)\
    ...
    \        return data[1];\n    }\n};\n\n} // namespace otukado\n"
  code: "#pragma once\n#include<vector>\n#include <cassert>\n\nnamespace otukado {\n\
    \n\ntemplate<typename T, T e, auto op> //SegmentTree<int, 0, [&](int a, int b)->\
    \ int {return max(a, b)}>\nclass SegmentTree {\nprivate:\n    int n;\n    int\
    \ size;\n    std::vector<T> data;\n    \npublic:\n    class Proxy {\n    private:\n\
    \        SegmentTree& seg;\n        int index;\n\n    public:\n        Proxy(SegmentTree&\

...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/problems/ITP2_8_B
    links:
    - https://onlinejudge.u-aizu.ac.jp/problems/ITP2_8_B
  bundledCode: "#line 1 \"tests/hash-table.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP2_8_B\"\
    \n\n#include <iostream>\n#include <string>\n\n#line 2 \"src/data-structure/hash-table.hpp\"\
    \n\n#include <algorithm>\n#include <cstdint>\n#include <list>\n#include <optional>\n\
    #line 8 \"src/data-structure/hash-table.hpp\"\n#include <utility>\n#include <vector>\n\
    ...
    \    }\n    return hash;\n};\n#line 7 \"tests/hash-table.test.cpp\"\n\nint main()\
    ...
    \ else {\n            table.erase(key);\n        }\n    }\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP2_8_B\"\n\n\
    ...
    n';\n        } else {\n            table.erase(key);\n        }\n    }\n}\n"
  dependsOn:
  - src/data-structure/hash-table.hpp
  ...
  verifiedWith: []
documentation_of: tests/hash-table.test.cpp
layout: document
redirect_from:
- /verify/tests/hash-table.test.cpp
- /verify/tests/hash-table.test.cpp.html
